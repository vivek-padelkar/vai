...
const prompts = {
    p1: 'Could you, suggest beautiful places to see on my upcoming road trip',
    p2: 'Briefly summarised this conecpt: Urban planning',
    p3: 'Brainstrom who could win upcoming FIFA world cup',
    p4: 'Do you know recent geopolitics?'
}
export const assets = {
    history_icon,
    menu_icon,
